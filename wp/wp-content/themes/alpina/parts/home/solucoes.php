<div id="solucoes" class="px-5 my-5 container">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-3">
        ...
        <a class="nav-link text-white me-0" href="#">Entrar em contato <img class="seta-link ms-3" src="<?= get_stylesheet_directory_uri(); ?>/assets/svg/seta-link.svg"></a>
    </div>
    <?php
    $query = new WP_Query([
        'post_type' => 'solucoes'
    ...
    if ($query->have_posts()) :
    ?>
        <div class="d-flex flex-column flex-lg-row justify-content-around align-items-center row">
            <?php while ($query->have_posts()) :
                $query->the_post();
            ?>
                <div class="solucao-home d-flex flex-column p-5 flex-grow-1 position-relative col">
                    <div class="icone-link position-absolute top-0 end-0 justify-content-center align-items-center">
